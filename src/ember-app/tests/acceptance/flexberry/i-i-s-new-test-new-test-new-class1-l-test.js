...
moduleForAcceptance('[AGAT] Acceptance | i i s new test new test new class1 l');

test('testing i-i-s-new-test-new-test-new-class1-l', function(assert) {
  visit('/i-i-s-new-test-new-test-new-class1-l');
